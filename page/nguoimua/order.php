...
<body>
    ...
    <div class="body-content" style="display: flex;margin-bottom:40px">
        <div class="sidebar">
            ...
            <div class="sidebar-item item-sidebar-checked" onClick="location.href='order'">
                <div class="item-logo-sidebar">
        ...
        <div class="noi-dung" style="background-color: transparent;">
            <div class="title-info">
                ...
                <span style="font-size: 0.9em;color:rgb(0,0,0,0.6)">Thông tin đơn hàng của bạn</span>
                <hr width="95%">
            </div>
            ...
            <div class="don-hang">
                <div class="cart-area">
                    <?php
                    $sql      = "SELECT gia_ship, id_donhang, ma_don, a.id_shop, ten_shop,gia_cod FROM donhang a,shop b WHERE a.id_user = $id_user and a.id_shop = b.id_shop and tinhtrang_donhang = 0 ORDER BY id_donhang DESC";
                            ...
                            if(mysqli_num_rows($ketqua1)>0)
                            {
                               while($row1 = mysqli_fetch_assoc($ketqua1))
                                ...
                                <div class="thanh-toan font-shopee2021-bold" style='color:#a56969;'>
                                    <button onclick="location.href='danh-gia?id_donhang=<?php echo $id_donhang; ?>'" class="font-shopee2021-bold bg-brown btn font-white" style='margin-right:auto;font-size:1.5em'>Đã Nhận Được Hàng</button>
